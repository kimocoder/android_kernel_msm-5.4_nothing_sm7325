...
git subtree add --prefix=techpack/camera camera $1
git subtree pull --prefix=techpack/camera camera $1
git subtree add --prefix=techpack/dataipa dataipa $1
git subtree pull --prefix=techpack/dataipa dataipa $1
git subtree add --prefix=techpack/datarmnet datarmnet $1
git subtree pull --prefix=techpack/datarmnet datarmnet $1
git subtree add --prefix=techpack/datarmnet-ext datarmnet-ext $1
git subtree pull --prefix=techpack/datarmnet-ext datarmnet-ext $1
git subtree add --prefix=techpack/display display $1
git subtree add --prefix=techpack/video video $1
