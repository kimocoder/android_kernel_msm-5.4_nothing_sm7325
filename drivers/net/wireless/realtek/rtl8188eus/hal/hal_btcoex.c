...
{
	if (rtw_mi_check_status2(padapter, MI_AP_ASSOC))
		return _TRUE;
...
u8 halbtcoutsrc_Get(void *pBtcContext, u8 getType, void *pOutBuf)
{
	...
	case BTC_GET_BL_WIFI_CONNECTED:
		*pu8 = (rtw_mi_check_status2(padapter, MI_LINKED)) ? _TRUE : _FALSE;
		break;
	...
	case BTC_GET_BL_WIFI_LINK:
		*pu8 = (rtw_mi_check_status2(padapter, MI_STA_LINKING)) ? _TRUE : _FALSE;
		break;
	...
	case BTC_GET_BL_WIFI_AP_MODE_ENABLE:
		*pu8 = (rtw_mi_check_status2(padapter, MI_AP_MODE)) ? _TRUE : _FALSE;
		break;
