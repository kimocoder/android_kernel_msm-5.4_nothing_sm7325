...
void LeaveAllPowerSaveModeDirect(PADAPTER Adapter)
{
	...
	if (rtw_mi_check_status2(Adapter, MI_LINKED)) { /*connect*/
 ...
 *
 * Return Value:
 *	_SUCCESS	rtw_cmd_thread2 can issue cmds to firmware afterwards.
 *	_FAIL		rtw_cmd_thread2 can not do anything.
 */
