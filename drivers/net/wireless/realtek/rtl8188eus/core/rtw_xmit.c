...
void	_rtw_init_sta_xmit_priv2(struct sta_xmit_priv *psta_xmitpriv)
{
...
static s32 xmitframe_swencrypt(_adapter *padapter, struct xmit_frame *pxmitframe)
{
	...
	if (pattrib->bswenc) {
		...
		RTW_INFO(ADPT_FMT" - sec_type:%s DO SW encryption\n",
			ADPT_ARG(padapter), security_type_str2(pattrib->encrypt));
#endif

		switch (pattrib->encrypt) {
		case _WEP40_:
		case _WEP104_:
			rtw_wep_encrypt2(padapter, (u8 *)pxmitframe);
			break;
		case _TKIP_:
...
void rtw_alloc_hwxmits2(_adapter *padapter)
{
